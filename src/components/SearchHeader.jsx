  ...
  return (
    <div className=" relative justify-center items-center ">
      <input
        ...
        className=" w-72 bg-white/85 py-1 px-4 border-2 border-pink-800 rounded-2xl focus:outline-none focus:ring-2 focus:ring-pink-600/35 hover:bg-white transition-all duration-300 lg:inline hidden "
      />
      <button
